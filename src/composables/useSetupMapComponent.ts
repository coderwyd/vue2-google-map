...
import { apiSymbol, customMarkerClassSymbol, mapSymbol, markerClusterSymbol } from '../shared/index'
...
export function useSetupMapComponent<T extends ICtorKey>(ctorKey: T, events: string[], options: Ref<IComponentOptions<T>>, emit: (event: string, ...args: unknown[]) => void): Ref<IComponent<T> | undefined> {
